...
import Actions from "../../redux/drill/actions";
...
export default function Drills() {
  ...
  const { drills, isDelete } = useSelector((state) => state.Drill);
  ...
  const goDetail=(id)=>{
    history.push(`/dashboard/drill/${id}`);
  }
