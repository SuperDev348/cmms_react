...
React.useEffect(() => { 
  if(pageState=="edit"){
    if(Object.keys(scheduledmaintenance).length !=0){
      ...
      setDblTimeEstimatedHours(scheduledmaintenance.dblTimeEstimatedHours);
        var inf={}; 
                       ...
                       <Form>
                          <Fieldset>
                            <Label>Estimated Labor</Label>                                   
                              ...
                              <FormItem
                                hasFeedback
                                validateStatus={(dblTimeEstimatedHours != "" && isNumeric(dblTimeEstimatedHours)) ? "success" : "error"}
                                help={(dblTimeEstimatedHours != "" && isNumeric(dblTimeEstimatedHours)) ? "" : "this field is number" }
                                style={{ width: "80%" }}
                              >
                              <Input 
                                placeholder=""
