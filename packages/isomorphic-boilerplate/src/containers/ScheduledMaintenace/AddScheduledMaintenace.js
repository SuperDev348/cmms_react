...
const { addSM,updateSMData } = SMAction;
...
export default function (props) {
  ...
  const { scheduledmaintenance,smID ,codeName} = useSelector((state) => state.ScheduledMaintenance);
  ...
  const [intStartAsWorkOrderStatusID,setIntStartAsWorkOrderStatusID]=React.useState(4);

  const [intSuggestedCompletion,setIntSuggestedCompletion]=React.useState(null);
  ...
  // 
  const [intScheduledMaintenanceStatusID,setIntScheduledMaintenanceStatusID]=React.useState(0);
  const [intAccountID,setIntAccountID]=React.useState(null);
  const [intChargeDepartmentID,setIntChargeDepartmentID]=React.useState(null);
               ...
               <Col md={20} sm={20} xs={20} style={colStyle}>
                  <Row style={rowStyle} gutter={gutter} justify="start">
                    ...
                    <Col md={6} sm={6} xs={24} style={colStyle}>
                        ...
                        <Switch checked={intScheduledMaintenanceStatusID?true:false} onChange={handleChange} />
                        <span
                          style={{
                            position: "absolute",
                            top: "27px",
                        ...
                        >
                          {intScheduledMaintenanceStatusID ? "Running" : "Paused"}
                        </span>
                      </div>                    
                    </Col>
                  </Row>
                        ...
                        <Fieldset>
                          ...
                          <div style={{ position: "relative" }}>
                            <Input
                              ...
                              onChange={()=>{setMaintainTypeModalActive(true);}}
                              style={{ width: "90%" }}
                            />
                            <i
                              className="ionicons ion-arrow-down-b"
                      ...
                      <Form>
                        <Fieldset>
                          ...
                          <Input
                              ...
                              onChange={(event)=>{setIntSuggestedCompletion(event.target.value)}}                       
                              style={{ width: "40px" }}
                            />
                            <span style={{position:"absolute",top:"5px",left:"45px"}}>days after WO created</span>
                            </div>
                         </Fieldset>
                      </Form>
                    </Col>
